...
const getPolicies = require('../src/service/PolicyService');
...
describe('Test get all policies', () => {
  ...
  it('Fetches policies', async () => {
    const clients = await getPolicies();
    expect(axios.request).toHaveBeenCalledTimes(2);
    const args = { method: 'get', url: '/api/policies', headers: { Authorization: 'Bearer undefined' } };
